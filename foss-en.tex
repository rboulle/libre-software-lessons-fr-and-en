...
\title[]{Free and open-source software : use, contribute, reuuse} 
...
\begin{frame}
  ...
  \titlepage
  \begin{figure}
    \includegraphics[scale=0.25]{images/logoiut.png}
  \end{figure}
  % \tableofcontents
\end{frame}
...
\begin{itemize}
\item understand free
  software : who ? how it works ? why ?
\item  know how to contribute to
  an existing project (not only a matter of git commit...) 
\item   understand why open source in a corporate environment * understand
  in depth GNU GPLv3, MIT,...  * know the big three families of
  licences * evaluate compliance between them and with proprietary
  software * use some basics skills to audit your code * deliver code
  that uses free software without unintended consequences...
\end{itemize}
...
%\subsection{Libre vs open-source}
...
%\begin{frame}{Limites des diffusives II}
%  Il y a oeuvre dérivée et donc diffusivité dès qu'il n'y a pas substituabilité.
%\end{frame}
...
\begin{frame}{Quelles compatibilités entre licences libres ?}
  ...
  \begin{alertblock}{Licence B est compatible avec licence A si :}
    ...
    \item les obligations de A sont inclues dans celles de B
    \end{itemize}
  \end{alertblock}
...
\begin{frame}{Analyse de la GPLv3}
...
\begin{frame}{Bonnes pratiques}
  ...
  \item Pas uniquement des juristes... Besoin de personnes avec connaissances techniques.
  \end{itemize}
...
C'est une chance que les composants impactés soient des logiciels libres...
...
Essentiellement trois solutions sur le marché :
\begin{itemize}
\item BlackDuck (fondé par des anciens de Microsoft)
\item FOSSology
\item Flexera
\end{itemize}
