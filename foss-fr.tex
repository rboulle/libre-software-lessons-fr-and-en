...
\begin{frame}{État des lieux, actualités}
  ...
  \begin{itemize}
  \item Circulaire du PM
    \href{http://circulaire.legifrance.gouv.fr/pdf/2012/09/cir_35837.pdf}{{\color{blue}Ayrault}}
    (2012).
  \item Loi ESR (2013) : "les logiciels libres de droit (!) sont
    utilisés en priorité "
  \item Référentiel Général d'Interopérabilité (2015) aka \href{http://references.modernisation.gouv.fr/sites/default/files/Referentiel_General_Interoperabilite_V2.pdf}{\color{blue}{RGIv2}}.
  \item Loi république numérique (2016) :
    \begin{itemize}
    ...
    \end{itemize}
  \item PJL "école de la confiance" (2019) : rejet de
    \textbf{priorité}, arguments infondés malgré
    \href{https://www.april.org/sites/default/files/20130612-note-legalite-disposition-legislative.pdf}{{\color{blue}analyse juridique de l'April.}}
